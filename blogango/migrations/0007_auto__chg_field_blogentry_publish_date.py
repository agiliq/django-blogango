...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blogango_blogentry', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 27, 0, 0)))

    def backwards(self, orm):

        # Changing field 'BlogEntry.publish_date'
        db.alter_column(u'blogango_blogentry', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
