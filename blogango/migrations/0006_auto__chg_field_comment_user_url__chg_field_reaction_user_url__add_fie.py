...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blogango_comment', 'user_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Reaction.user_url'
        db.alter_column(u'blogango_reaction', 'user_url', self.gf('django.db.models.fields.URLField')(max_length=200))
        # Adding field 'BlogEntry.publish_date'
        db.add_column(u'blogango_blogentry', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'BlogEntry.text'
        db.alter_column(u'blogango_blogentry', 'text', self.gf('markupfield.fields.MarkupField')(rendered_field=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Comment.user_url'
        db.alter_column(u'blogango_comment', 'user_url', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Reaction.user_url'
        db.alter_column(u'blogango_reaction', 'user_url', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'BlogEntry.publish_date'
        db.delete_column(u'blogango_blogentry', 'publish_date')


        # Changing field 'BlogEntry.text'
        db.alter_column(u'blogango_blogentry', 'text', self.gf('markupfield.fields.MarkupField')())
